				...
				<div class="panel-body">
					<form action="${pageContext.request.contextPath}/area/logar" method="post">
						<div class="form-group col-md-6">
							...
							<input id="localOrigem" class="form-control" name="funcionario.cpf" type="text" placeholder="Informe seu CPF" autofocus />
						</div>
						<div class="form-group col-md-6">
							<label for="localDestino">Senha</label>
							<input id="localDestino" class="form-control" name="funcionario.senha" type="password" placeholder="Informe sua senha" />
						</div>
