...
<layout:page titulo="Pessoas">
	<div class="row">
		<div class="panel panel-default">
			<div class="panel-heading">
				Usuários
				<a class="btn btn-success btn-sm pull-right" href="${pageContext.request.contextPath}/pessoa/cadastro">
			...
			<div class="panel-body">
				<div class="panel panel-default">
				<div class="panel-body">
					<form action="${pageContext.request.contextPath}/pessoa/buscar" method="post">
						...
						<c:forEach items="${listaDePessoas}" var="pessoa">
							<tr>
								...
								<td><a class="btn btn-primary btn-sm" title="Editar"
									href="${pageContext.request.contextPath}/pessoa/edita?cod=${pessoa.id}">
